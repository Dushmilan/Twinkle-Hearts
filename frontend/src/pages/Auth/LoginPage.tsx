...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-greeting-bg-500 px-4 py-12">
      {/* Decorative sparkles */}
      <div className="absolute top-20 left-16 w-2 h-2 bg-greeting-cyan-500 rounded-full animate-float opacity-40 hidden lg:block" />
      <div className="absolute bottom-20 right-20 w-1.5 h-1.5 bg-greeting-magenta-500 rounded-full animate-float-slow opacity-30 hidden lg:block" />
        ...
        <div className="card rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-sm text-greeting-magenta-400 hover:text-greeting-magenta-300 font-medium">
                Forgot password?
              </a>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-greeting-purple-700"></div>
              </div>
            ...
            <button
              type="button"
              className="mt-4 w-full flex items-center justify-center gap-3 card border border-gray-200 text-gray-300 py-3 rounded-lg font-medium hover:bg-greeting-purple-700 hover:border-greeting-magenta-400 transition-all"
            >
          ...
          <p className="mt-8 text-center text-sm text-gray-400">
            ...
            <Link to="/register" className="font-medium text-greeting-magenta-400 hover:text-greeting-magenta-300">
              Sign up now
            </Link>
          </p>
        </div>
