      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-paper-md p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-ink-500 mt-1">Join TwinkleHearts today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <div className="input-field bg-gray-50 text-ink-600 w-20 text-center font-medium" aria-label="Country code">
                  {COUNTRY_CODE}
                </div>
                <input
                  id="phone"
              ...
              {formData.password && (
                <div className="mt-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-ink-500">{getPasswordStrengthLabel()}</span>
                  </div>
                </div>
              )}
          ...
          <p className="mt-8 text-center text-sm text-ink-500">
            ...
            <Link to="/login" className="font-medium text-ruby-600 hover:text-ruby-700">
              Sign in
            </Link>
          </p>
        </div>
