        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-4">
              <Link to="/admin" className="text-greeting-magenta-400 hover:text-greeting-magenta-300 font-medium">
                Back to Dashboard
              </Link>
              <button
                onClick={() => {
                ...
                className="bg-greeting-magenta-500 text-gray-100 px-6 py-3 rounded-lg font-semibold hover:bg-greeting-magenta-600 transition"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-greeting-magenta-500 focus:border-transparent"
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="w-4 h-4 text-greeting-magenta-400 border-gray-300 rounded focus:ring-greeting-magenta-500"
                  disabled={isUploadingImages}
                />
              ...
              <div className="flex gap-4">
                <button
                  type="submit"
                  disabled={isUploadingImages}
                  className="bg-greeting-magenta-500 text-gray-100 px-6 py-3 rounded-lg font-semibold hover:bg-greeting-magenta-600 transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isUploadingImages 
                    ? 'Uploading...' 
        ...
        <div className="bg-white rounded-lg shadow-md p-4 mb-6">
          <div className="flex gap-4">
            <input
              ...
              className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-greeting-magenta-500 focus:border-transparent"
            />
            <button
                    ...
                    <tr key={product.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        <button
                          ...
                          className="text-greeting-magenta-400 hover:text-greeting-magenta-300 font-medium mr-4"
                        >
                          Edit
                        </button>
                        <button
